    ...
    <section id="contacto" className="bg-brandAmberLight py-14 sm:py-16">
      <div className="container-page grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
        ...
        <div className="reveal-on-scroll flex flex-col gap-3 sm:flex-row lg:flex-col">
          ...
          <a href={siteConfig.emailUrl} className="inline-flex min-h-12 min-w-56 items-center justify-center gap-2 rounded-md border border-brandInk/20 bg-white px-5 py-3 text-sm font-black text-brandInk transition hover:-translate-y-0.5 hover:border-brandGreen"><Mail size={18} aria-hidden="true" /> {copy.email}</a>
